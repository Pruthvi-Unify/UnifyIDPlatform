import {
  ...
  matchRoutes,
  useLoaderData
} from "/build/_shared/chunk-KROG52SD.js";
import {
  FacebookButton,
  GoogleButton,
  useForm
} from "/build/_shared/chunk-GS2IEBPY.js";
import {
  Anchor,
  Button,
  Checkbox,
  ...
  TextInput,
  useToggle
} from "/build/_shared/chunk-YSG4TDMY.js";
import {
  __commonJS,
  __esm,
  __export,
...
function utf16leSlice(buf, start, end) {
  ...
  for (var i = 0; i < bytes.length; i += 2) {
    res2 += String.fromCharCode(bytes[i] + bytes[i + 1] * 256);
  }
  return res2;
}
  ...
  "node-modules-polyfills:string_decoder"() {
    ...
    StringDecoder.prototype.end = function(buffer) {
      ...
      if (buffer && buffer.length)
        res2 = this.write(buffer);
      if (this.charReceived) {
        var cr = this.charReceived;
        var buf = this.charBuffer;
        var enc = this.encoding;
        res2 += buf.slice(0, cr).toString(enc);
      }
      return res2;
    };
  }
...
var init_readable = __esm({
  "node_modules/rollup-plugin-node-polyfills/polyfills/readable-stream/readable.js"() {
    ...
    Readable.prototype.on = function(ev, fn) {
      var res2 = events_default.prototype.on.call(this, ev, fn);
      if (ev === "data") {
...
function login(props) {
  const flow2 = useLoaderData();
  const res1 = import_node.useActionData;
  const [type2, toggle] = useToggle(["login", "register"]);
  const form = useForm({
    initialValues: {
      identifier: "",
      password: "",
 ...
 * @license MIT
 */
//# sourceMappingURL=/build/routes/login-ZK4ZJNHS.js.map
